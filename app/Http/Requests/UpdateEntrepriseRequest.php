<?php
// app/Http/Requests/UpdateEntrepriseRequest.php
    ...
    public function rules()
    {
        ...
        return [
            'nom' => [
                ...
                'string',
                'max:255',
                Rule::unique('entreprises', 'nom')->ignore($entrepriseId)
            ],
            'email' => [
                'nullable',
                'email',
            ...
            'numero_registre' => [
                ...
                'string',
                'max:100',
                Rule::unique('entreprises', 'numero_registre')->ignore($entrepriseId)
            ],
            'statut' => 'sometimes|required|in:ACTIVE,INACTIVE,SUSPENDUE',
        ];
    }
